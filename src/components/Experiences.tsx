...
import { useToggleDisplay } from "@/hooks/useToggleDisplay"; // Adjust the import path as necessary
import { GridDisplay } from "./GridDisplay"; // Adjust the import path as necessary
import ToggleButton from "./ToggleButton"; // Adjust the import path as necessary
import { experienceData } from "@/lib/data"; // Adjust the import path as necessary
import Separator from "./Separator";

// Assuming we have a type for our experience data
