      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            exit={{ x: -200 }}
            className="px-6 z-[100] py-10 bg-neutral-100 max-w-[14rem] lg:w-fit fixed lg:relative h-screen left-0 flex flex-col"
          >
            ...
            <div className="mt-auto pt-4 pb-20 lg:pb-4">
              <Badge href="/Shlomo_Dahan_resume.pdf" text="View Resume" />
            </div>
          </motion.div>
        )}
      </AnimatePresence>
  ...
  return (
    <div className="flex space-x-2">
      ...
      <div className="flex text-sm flex-col justify-center">
        <p className="font-bold text-primary">Shlomo Dahan</p>
      </div>
    </div>
  );
};
